...
const Navbar = () => {
    ...
    return (
        <div className=" navbar mx-10 bg-base-100 ">
            <div className=" navbar  ">
                ...
                <div className="flex-none"><a href='www.google.com' className="btn btn-ghost normal-case text-xl">Doctors Portal</a></div>

            </div>


            <div className="lg:justify-between navbar hidden lg:flex  ">
